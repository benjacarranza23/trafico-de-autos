...
def dibujar(self, superficie):
        """Dibuja el auto en la superficie dada."""
        superficie.blit(self.image, self.rect)

class AUTOS_CARRETERA:
    """Clase que representa los autos de la carretera"""
    def __init__(self):
        """Inicializa un auto de la carretera en una posición aleatoria en la parte superior."""
    ...
    def mover(self):
        """Mueve los autos de la carretera hacia abajo."""
